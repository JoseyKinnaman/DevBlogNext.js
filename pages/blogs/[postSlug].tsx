...
export const getStaticPaths : GetStaticPaths = ()=> {
  ...
  // falback options
  // false => this will return 404 for new unknown slug
  // blocking => this will first see the slug and it will try to get data form static pages and if there is no page it will first hang the browser and try to generate a new page
// true => return the fake page for sometime and once the data is ready it will serve it as page props
